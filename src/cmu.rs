...
lazy_static! {
    static ref CMU_DICT: Result<HashMap<String, Vec<Vec<String>>>, Error> = from_json();
}
...
fn from_json() -> Result<HashMap<String, Vec<Vec<String>>>, Error> {
    let dict_json = include!("cmudict.json");
